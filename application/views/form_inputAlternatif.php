						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div id="body">
										<a href="<?php echo site_url('Alternatif/index') ?>"><b>Kembali</b></a>
										<form action="<?php echo site_url('Alternatif/insert') ?>" method="POST">
											Nama Kamar <br>
											<input type ="text" name = "nama"></input> <br>
											Tipe Kamar <br>
											<input type ="text" name = "tipe"></input> <br>
											Harga<br>
											<input type ="text" name = "harga"></input> <br>
											Bintang<br>
											<input type ="text" name = "bintang"></input> <br>
											Fasilitas<br>
											<input type ="text" name = "fasilitas"></input> <br>
											Strategis<br>
											<input type ="text" name = "strategis"></input> <br> <br>
