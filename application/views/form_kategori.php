						...
						<div class="row">
							<div class="col-xs-12" align="center">
								<!-- PAGE CONTENT BEGINS -->
									...
									<a href="<?php echo site_url('Kategori/form_input/') ?>">
										<b>Tambah Data Kategori</b>
									</a>
									<table border="2">
										<tr align="center">
											<td> &nbsp No &nbsp </td>
											<td> &nbsp Kategori &nbsp </td>
											<td>Opsi</td>
										</tr>
										...
										<?php 
											...
											<tr align="center">
												...
												<td>
													<a href="<?php echo site_url('Kategori/edit/' .$r['id_kategori']) ?>">
													&nbsp Edit &nbsp
													</a>

														||
													<a href="<?php echo site_url('Kategori/delete/' .$r['id_kategori']) ?>"> 
													&nbsp Hapus &nbsp
													</a>
												</td>
											</tr>
